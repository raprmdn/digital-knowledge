                ...
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Update Main Menu</h3>
                        </div>
                    </div>
                </div>
                @if (session('success'))
                    ...
                    <div class="col-lg-12">
                        <div class="card card-preview">
                            <div class="card-inner">
                                <form action="{{ route('main.menu.edit', $menu) }}" method="post" class="form-validate">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-label" for="menu_name">Main Menu Name</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="only for parent menu" value="{{ old('menu_position') ?? $menu->position }}">
                                                @error('menu_position')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                placeholder="example : icon ni ni-list-index" value="{{ old('menu_icon') ?? $menu->icon }}">
                                                @error('menu_icon')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
