            ...
            <div class="nk-content-body">
                <nav class="mb-3">
                    <ul class="breadcrumb breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('menu.category.create') }}">Edit Category</a></li>
                    </ul>
                </nav>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-preview">
                            <div class="card-inner">
                                <form action="{{ route('menu.category.edit', $category->category_slug) }}" method="post">
                                    @csrf
                                    @method('put')
                                    @include('backend.categories.partials.form-control')
                                </form>
                            </div>
                        </div>
                    </div>
