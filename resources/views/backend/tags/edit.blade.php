            ...
            <div class="nk-content-body">
                <nav class="mb-3">
                    <ul class="breadcrumb breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('menu.tag.create') }}">Edit Tag</a></li>
                    </ul>
                </nav>
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">Edit Tag</h3>
                        </div>
                    </div>
                </div>
                @if (session('success'))
                    ...
                    <div class="col-lg-12">
                        <div class="card card-preview">
                            <div class="card-inner">
                                <form action="{{ route('menu.tag.edit', $tag->tag_slug) }}" method="post">
                                    @csrf
                                    @method('put')
                                    @include('backend.tags.partials.form-control')
                                </form>
                            </div>
                        </div>
                    </div>
